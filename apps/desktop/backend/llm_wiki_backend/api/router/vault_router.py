...
@router.post("/select", response_model=SelectVaultResponse, description="Validate and select a vault path")
...
@router.post("/configure", response_model=ConfigureVaultResponse, description="Configure the vault")
...
@router.post(
    ...
    description="Create required vault folders, index/log files, database, and config",
)
...
@router.get("/status", response_model=StatusResponse, description="Get vault status, git detection, and Obsidian CLI availability")
